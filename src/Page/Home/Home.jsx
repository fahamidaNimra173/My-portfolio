  ...
  const skillsData = [
    {
      ...
      skills: [
        ...
        {
          name: "Tailwind CSS",
          icon: <SiTailwindcss className="text-sky-400" size={40} />,
        },
        {
          name: "JavaScript ",
        ...
        {
          name: "DaisyUI",
          icon: <SiDaisyui className="text-pink-400" size={40} />,
        },
        ...
        {
          name: "React Router",
          icon: <SiReactrouter className="text-red-500" size={40} />,
        },
        {
          name: "Firebase",
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "TanStack Query",
          icon: <PiSunHorizonFill className="text-red-400" size={40} />,
        },
        { name: "Axios", icon: <SiAxios className="text-blue-400" size={40} /> },
        {
          name: "Moment.js",
          icon: <IoMdTime className="text-green-300" size={40} />,
        },
      ],
    },
    {
      ...
      skills: [
        ...
        {
          name: "Netlify",
          icon: <SiNetlify className="text-sky-400" size={40} />,
        },
        { name: "Canva", icon: <SiCanva className="text-blue-400" size={40} /> },
        {
          name: "Framer Motion",
          icon: <SiFramer className="text-pink-500" size={40} />,
        },
    ...
    <div className="min-h-screen scroll-smooth">
      ...
      <div className="hidden relative md:flex md:flex-row gap-10 md:gap-5 items-start min-h-screen">
        ...
        <div className="bg-black sticky top-0 min-h-screen shadow-fuchsia-400 patterned-bg shadow-2xl text-center md:px-10 px-3 py-15 lg:px-20 md:py-20 flex-shrink">
          <div className="absolute h-56 w-56 blur-3xl rounded-full top-70 left-15 border-8 border-white bg-fuchsia-700"></div>
          <div className="absolute h-56 w-56 blur-3xl -top-10 left-35 bg-fuchsia-500"></div>
          <div className="absolute h-40 w-40 blur-3xl top-70 left-40 border-8 border-white bg-yellow-500"></div>
          <div className="absolute h-56 w-56 blur-2xl top-90 left-50 bg-black"></div>
          <div className="absolute h-96 w-72 blur-xl top-0 left-23 bg-black"></div>
          <div className="absolute h-56 w-56 rounded-full blur-3xl top-120 left-30 border-8 border-white bg-yellow-700"></div>
        ...
        <div className="flex-1 overflow-x-hidden relative pl-3 pt-30 lg:pt-25 space-y-9 max-h-screen overflow-y-auto">
          <div className="absolute h-40 w-96 blur-3xl top-5 left-80 -z-10 bg-fuchsia-700"></div>
          <div>
          ...
          >
            ...
            <div className="relative grid md:grid-cols-2 gap-12 items-center z-10 px-8 py-5 w-full h-full">
              ...
              <div className="relative text-center py-20 z-20">
                <h1 className="text-4xl font-bold libertinus mb-10 bg-gradient-to-r from-[#000000] via via-[#d015ff] to-whit">
                  Get in Touch
                </h1>
                <p className="text-lg mb-8 alice text-gray-200">
                  Open to crafting interfaces that feel like art and function
                  like magic!
                </p>
      ...
      <div className="md:hidden relative pt-25 space-y-6">
        <div className="absolute h-40 w-72 blur-3xl top-5 left-60 -z-10 bg-fuchsia-700"></div>
          ...
          <div className="flex-1 px-5 text-center">
            ...
            <div className="flex gap-5 items-center justify-center mt-6">
              <a
                ...
                download="FAHMIDA NIMRA Resume-MERN Stack Developer-fahmidanimra@gmail.pdf"
              >
                <button class="frutiger-button">
                  <div class="inner">
                    <div class="top-white"></div>
                ...
                >
                  ...
                  <div className="grid grid-cols-3 lg:grid-cols-5 lg:gap-6 gap-3">
                    {section.skills.map((skill, i) => (
                      <div
                        key={i}
                        className="flex flex-col items-center flex-wrap skill-card"
                      >
        ...
        >
          ...
          <div className="relative mt-5 grid md:grid-rows-2 gap-2 items-center z-10 px-2 py-10 w-full h-full">
            ...
            <div className="relative text-center bg-black/40 pt-5 pb-5 z-20">
              ...
              <p className="text-lg mb-8 alice text-gray-200">
                Open to crafting interfaces that feel like art and function like
                magic!
              </p>
