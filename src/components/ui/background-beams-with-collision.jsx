...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        " md:h-[20rem] relative flex items-center w-full justify-center overflow-hidden",
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-[2px] rounded-full bg-gradient-to-t from-indigo-500 via-purple-500 to-transparent",
